...
public class EntityGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir("D:\\javaweb\\express-parent\\express-auth\\src\\main\\java");
        ...
        pc.setParent(null);
        pc.setEntity("com.cwj.express.auth.domain");
        pc.setMapper("com.cwj.express.auth.dao");
        pc.setXml("com.cwj.express.auth.dao.mapping");
